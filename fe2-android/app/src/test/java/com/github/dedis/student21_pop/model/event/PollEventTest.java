...
public class PollEventTest {
  ...
  //  private final PollEvent event1 =
  //      new PollEvent(name1, startTime, endTime, lao, location, choices, true);
  //  private final PollEvent event2 =
  //      new PollEvent(name2, startTime, endTime, lao, location, choices, false);
  //
  //  @Test
  //  public void createEventWithNullParametersTest() {
  //    assertThrows(
  //        IllegalArgumentException.class,
  //        () -> new PollEvent(name1, startTime, endTime, lao, location, null, true));
  //    assertThrows(
  //        IllegalArgumentException.class,
  //        () -> new PollEvent(name1, startTime, endTime, lao, location, choicesNull, true));
  //  }
  //
  //  @Test
