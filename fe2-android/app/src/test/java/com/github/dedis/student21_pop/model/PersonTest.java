package com.github.dedis.student21_pop.model;
...
public class PersonTest {
  ...
  //  private final ArrayList<String> laosWithNull =
  //      new ArrayList<>(Arrays.asList("0x3939", null, "0x4747"));
  ...
  //    assertThrows(
  //        IllegalArgumentException.class, () -> new Person(name1, null, keys.getPrivateKey(),
  // laos));
  //    assertThrows(
  //        IllegalArgumentException.class, () -> new Person(name1, keys.getPublicKey(), null,
  // laos));
  //    assertThrows(
  //        IllegalArgumentException.class,
