package com.github.dedis.student21_pop.model.event;
...
public class EventTest {
  ...
  //    assertThrows(
  //        IllegalArgumentException.class, () -> new Event(null, lao, startTime, location, type));
  //    assertThrows(
  //        IllegalArgumentException.class, () -> new Event(name1, null, startTime, location,
  // type));
  //    assertThrows(
  //        IllegalArgumentException.class, () -> new Event(name1, lao, startTime, null, type));
  //    assertThrows(
  //        IllegalArgumentException.class, () -> new Event(name1, lao, startTime, location, null));
  //  }
  //
  //  @Test
  ...
  //    //    assertThat(event1.getId(), is(Hash.hash(type.getSuffix(), lao, event1.getTime(),
  // name1)));
  //    //    assertThat(event2.getId(), is(Hash.hash(type.getSuffix(), lao, event2.getTime(),
  // name2)));
  //  }
  //
  //  @Test
