package com.github.dedis.student21_pop.model.network.method.message;
...
public class MessageGeneralTest {
  ...
  //      new MessageGeneral(sender1.getPublicKey(), data, signature1, messageId1, new
  // ArrayList<>());
  //  private final MessageGeneral messageGeneral2 =
  //      new MessageGeneral(sender2.getPublicKey(), data, signature2, messageId2, new
  // ArrayList<>());
  //
  //  @Test
  ...
  //        IllegalArgumentException.class,
  //        () ->
  //            new MessageGeneral(sender1.getPublicKey(), data, null, messageId1, new
  // ArrayList<>()));
  //    assertThrows(
  //        IllegalArgumentException.class,
  //        () ->
  //            new MessageGeneral(sender1.getPublicKey(), data, signature1, null, new
  // ArrayList<>()));
  //    //    assertThrows(
  //    //        IllegalArgumentException.class,
  //    //        () -> new MessageGeneral(sender1.getPublicKey(), data, signature1, messageId1,
  // null));
  //  }
  //
  //  @Test
