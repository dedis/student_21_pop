package com.github.dedis.student21_pop.model.network.answer;
...
public class AnswerTest {
  ...
  //        }
  //      };
  //  private final Result result = new Result(0, resultJson);
  ...
  //    assertThat(result.getResult(), is(resultJson));
  //  }
  //
  //  @Test
  ...
  //    assertNotEquals(result, new Result(2, resultJson));
  //
  ...
  //    assertNotEquals(result.hashCode(), (new Result(2, resultJson)).hashCode());
  //
